...
v)	If a bot is not able to cross a particular checkpoint	then it
can skip that checkpoint.
...
c)	General Rules:
i)	The teams must adhere with the spirit of healthy
competition.
...
iv)	The time measured by the organizers will be final and
will be used for scoring the teams.
v)	Time measured by any contestant by any means will	not be accepted for scoring.
vi)	In case of any disputes/discrepancies, the coordinator decision will be final and binding.
...
ix)	All decisions taken by the organizing team will be final.
No argument will be encouraged
x)	A person is allowed to control only one bot in the
tournament.
 
d)	Game Rules:
i)	The machine would be checked for its safety	before the run
and would b disqualified if found unsafe for other participants.
...
ii)	In skip, an equivalent point is added in the participant track
completion time as penalty time.
...
2.	Certificates of participation will be only given to the participating teams.

g)	System Specifications-
1.	The dimensions of the bot should be less than or equal to 300 mm X 300 mm X 300 mm (l*b*h), failing which the team will be disqualified from the competition.
2.	The bot should be controlled manually.
3.	Teams can use both wired as well as wireless control mechanisms. In case of wired bots, the length of wire should be minimum 4 meters so that the wire remains slack at any instant of time. If the participants use wireless mechanisms then it is mandatory to use a dual frequency remote.
4.	The dimensions of the remote are not included in the size constraint of the bot.
5.	The bot can have an on-board or off-board power supply.
6.	Only upto 5% tolerance will be allowed else the bot will be unfit for the game and will lead to disqualification
 
Registration Fee - 600/-(per
Team)
Prize = 25K Worth Contacts:
Deepanshu – 9024915414
Chetan – 9610554991
...
DATE – 20/03/2024
Introduction
For all those who have passion in Robotics or Sports,
RENAISSANCE’24 presents robo-soccer. This competition is to show how good and swift robot of yours can be by playing soccer using it and scoring more goals.
...
Preliminary Stage:
There will be one robot per team. At each side of the arena there will be a set of colored balls. The robots of teams have to push the balls in the opponent’s arena goal post and score the
points. The teams winning in the preliminary stage will move to the knockout stage and the losing team will be out of the competition.

Knock-Out Stage
The team which scores maximum number of goals within the given
time in football-type
arena will win the match.
...
vii)	Our team will not be responsible for the noises created due to same frequencies in wireless communication between two teams during game.
...
xii)	All decisions taken by the organizing team will be final. No argument will	be
encouraged.
xiii)	A person is allowed to control only one bot in the tournament.

Preliminary Stage:
i)	The teams will have to push maximum number of balls from
their arena to the opponent’s arena.
ii)	At the same time, teams must also try to push opponent’s balls into the opponent’s arena.
iii)	At the end of given time, team which has the maximum number of ball at the opponents arena will be judged as the winner.
iv)	In this stage your main aim is to push maximum number of balls
to the opponent's arena.
v)	Any team member is not allowed to touch the robot during the match except during breaktime.
vi)	In case of tie, additional 1 min will be provided for competing.

Knock-Out Stage:
i)	The team should score maximum number of goals in order to
win the match.
ii)	Kicking mechanism can be used here to score goals.
iii)	The knock-out stage will have two halves, each of 3 min with a breaktime of 1 min between the two halves.
iv)	The robot can move in the whole arena.
v)	In case of tie, additional 1 min will be given for competing. If tie still persists, coordinators will decide the winner on the basis of performance.
vi)	In case the robot of Team A gets stuck with robot of Team B during the match then both
the robots will be placed to the starting position. Violation of any of the above rules will lead to disqualification.
...
anytime.
f)	Only upto 5% tolerance will be allowed else the bot will be unfit for the game and will lead to disqualification.
Certificate Policy-
1.	Top three teams will be rewarded and given prizes.
2.	Certificates of participation will be only given to the participating
teams.

Registration Fee:- 600/-(per Team) Prize = 25K Worth
Contacts:
Ashish - 8183838346
Jeeves - 8190086164
...
•	There can be any number of registration from a same team (The machine should be different in each registration.
•	The participation team will be given maximum time of seven minutes to complete the track.
•	The participating teams will be allowed to take a time out of maximum
of 3 minutes. (The total time would exclude the timeout of 3 minutes).
•	The type of drone should not be changed after the competition has started.
•	Replacement of the parts of Drone will only be allowed in case if accident occurs or the part gets damaged.
•	The Drone will be scored on basis of the points earned for crossing / navigating through each of the hurdles, the team scoring the maximum points and avoiding all eliminations at different stages will be declared as WINNER.
•	Drones that cause deliberate interference with other drones or

Organizing Committee:
•	All decision regarding scoring, gameplay and timing are made by the organizing officials.
...
EVENT NAME - ROBO-WAR
Problem Statement:
To design a machine that can fight to another one. The
competition will be played on a knock-out basis. The maximum weight of the bot should be 30 Kg.
RULES:
•	The competition will be played on a knock out basis
•	The maximum duration of each round will be 2 minutes. Any
team that is not ready at the time specified will be disqualified from the competition automatically.
•	If the bot is unable to displace from it's position for more than 30 sec than the bot would be disqualified from the particular round.
...
highlighted on the website and notified to the registered teams. Violation of any of the above rules will lead to disqualification.
...
•	The base of the arena is made up of metal sheet of width 5 mm
•	The walls of the arena will be made up of polycarbonate film of width 6mm.

Machine Specification:
•	The following size limitations apply for each robot Width-750mm max
Length-750mm max Height-1000mm max
•	Maximum weight of the machine should not exceed 30 kg including power source for Robo-war Pro.
•	Machine can use maximum 24 volts at any given point of time to any particular component of the robot. The machine can be operated with wired or wireless remote. Ready-made bases of machines would not be allowed (Readymade wheels, motor,
battery, RF Remote, switch, wires can be used)

Power Sources
1.	The machine can be powered electrically only. Use of an IC engine in any form is not allowed.
2.	Each team must have its own power sources. The teams have to bring their own battery eliminators.
3.	The voltage difference between any two points in the machine should not be more than 36V DC at any point of time.
4.	All connections should be made safe to prevent short circuits and battery fires. Any unsafe circuitry may be asked to be replaced. Failure to do so will result in disqualification.
...
7.	It is suggested to have extra batteries ready and charged up during competition so that on advancing to next level, you don't have to wait or suffer due to uncharged battery. If teams don't show up on allotted slot, they will be disqualified.

Mobility
1.	All robots must have clearly visible and controlled mobility mechanism in order to compete.
2.	Methods of mobility may include:
•	Rolling (wheels, tracks or the whole robot).
•	Walking (linear actuated legs with no rolling or cam operated
•	motion).
•	Shuffling (rotational cam operated legs).
3.	Jumping and hopping is not allowed.
4.	Flying (using aero foil, helium balloons, ornithopters, etc.) is not allowed.
*Any other method of mobility which leads the robot
to lose contact with the ground is not allowed.

Robot control requirements:
1.	Both wired and wireless remote controls are allowed in the
event.
2.	All wires coming out of the robot should be bundled as a single unit.
3.	The wires should be properly protected and insulated.
4.	The wire should be sufficiently long so as to remain slack at all time during the competition.
5.	In case of wireless remote controls, the remote should have at least two frequency operations to prevent interference with other team.
6.	Teams are recommended to attach a pipe to bot in vertical direction through which wires come out. The length of pipe will not be considered in bot dimension.


Rules for Pneumatics and hydraulics:
1.	The robot must use non-inflammable and non-corrosive fluids to
power pneumatic and hydraulic devices.
2.	Maximum pressure in the tank containing pneumatic fluid should not exceed the limit of 10 bars and there should be a provision to check the pressure in the tank.
3.	All hydraulic liquids are required to be non-corrosive and your device should be leak proof. The maximum pressure in cylinder
should not exceed the rated pressure at any point of time.
4.	Participants must be able to indicate the used pressure with integrated or temporarily fitted pressure gauge.
5.	You must have a safe way of refilling the system
6.	All pneumatic components on board a robot must be securely mounted. Care must be taken while mounting the pressure vessel and armour, to ensure that if ruptured it will not escape the robot.
...
6.	All participants build and operate robots at their own risk.
Combat
robotics is inherently dangerous. There is no amount of regulation that
can encompass all the dangers involved. Please take care to not
hurt
yourself or others when building, testing and competing. Any
kind of activity (repairing, battery handling, pneumatics systems etc.)
which may cause damage to the surroundings during the stay of
the
teams in the competition area should not be carried out without the
consent of organizers. Not following this rule may result in disqualification.
7.	All the resources provided at the time of competition from the organizers should be strictly used only after the consent of the
organizers.
8.	Once the robots should enter into the arena, no team member can
enter into the arena at any point of time. In case if a fight has to be

NOTE:
Qualification of a robot to next level be subjective and totally on the decision of the judges. A robot winning in a round against its doesn’t guarantee its entrance into the next round. If the judges found the winner. Robot incompetent to enter into the next round, it may get disqualified. Judges can disqualify both the robots of a match from advancing to the next round.
...
Contact:
Sidhant – 9810290156
Manvendra - 9358943559



Event: 3D MANIA

In this event participants are challenged to design 3D object on AutoCAD and 3D printer. RULES:
ROUND 1: It is divided into two parts.
1.	Quiz (15 questions/15 marks/10 min.)
2.	2D drawing (1 drawing/25 marks/30 min.)
ROUND 2: The student who qualifies 1st round will only move to the 2nd round. Contestants will be given a 3D drawing and its all three views (F.V., T.V., and S.V.) would have to be drawn with dimensions in 90 min. (60 marks)
ROUND 3: Printing of top 5 drawings using 3D printer.
Final result will be declared on the basis of all three stages. Evaluation Criteria:
•	Time
•	Accuracy

GUIDELINES:
1.	It is individual participant’s event.
2.	No other accessories will be provided rather than Question Paper during I & II round.
3.	We will provide all the required materials.
4.	No external electronic devices will be allowed.
5.	If system problem occurs, it will be short out at the time of event.
6.	Decision of judges will be final and cannot be argued. ENTRY FEE : Rs.250 (Per Candidate)
1st Prize : Rs.3000 2nd Prize : Rs.2000 3rd Prize : Rs. 1000
...
Rules:
1.	Only team (maximum of 3 person) entries are eligible.
2.	Audiences shall not give any hints or clues to the competitors.
3.	Decision of judges will be final and binding. 
ROUND 1:
...
ROUND 2:
STAGE-I [Rapid Fire Round]: A question will be asked to a team and if they are unable to answer it will be passed to the next team. Answering time is only 15 seconds (2 marks for correct answer, 1 negative mark for wrong answer and no marks if team pass the question to next team).
STAGE-II [Tech. Dumb Charades]: Identify the object with the help of gesture. (2 marks for correct answer). In case the team is not able to answer then the question would be passed to the audience.
STAGE-III [Buzzer Round]: 10 questions would be asked. A question will be fired and the team who presses the buzzer first will answer (2 marks for correct answer and 1 negative mark for wrong answer). Unanswered/Wrong answered questions will be passed to audiences.
...
Event: RESIN-O-CLOCK
Resin art is the practice of using epoxy resin in artwork. With it, you can create art that is clear and luminous, as well as artwork that has depth.
In this event students will make small decorative items using epoxy resin. RULES:
•	Team of 3 members participation.
ROUND 1:
•	Mould Preparation
•	Those who clear first round goes to next round
ROUND 2:
•	The participant will made a product with the help of Epoxy. GUIDELINES: In this round the material will be provided.
...
RULES:
•	Wheelbase up-to 65inch & Track width 60-80% of wheelbase.
•	Minimum Ground Clearance of vehicle should be 1.5 inch.
•	The team/vehicle must have all safety equipment's in proper working condition (e.g. driver suit, kill switch, fire extinguisher etc.)
•	I.C. Engine capacity -160cc Max.
•	Electric Motor Rating -3Kw max.
GUIDELINE: Student identity card, Driver Insurance, and Driving Licence are needed before participation in the event:.
 
There will be three rounds. Round one (brake test) will be qualifying round.
...
ROUND-2. Skid Pad : The objective of the skid-pad event is to measure the vehicle's cornering ability on a flat surface while making a constant-radius turn. This round will have a weightage of 25% of final team score.
ROUND-3. Endurance Race: The Endurance race is designed to evaluate the overall performance of the vehicle and to test the vehicle's reliability. This round will have a weightage of 75% of final team score.
Final results will be announced on the basis of combined score of round 2 and round 3. ENTRY FEE: Rs. 5000 Per Team (approx. 10 members.)
#1st prize Rs. 25000	#2nd prize Rs. 15000



EVENT NAME - Dexterity- "Bridge O Mania"
Date 19/03/2024
About the Event: The event here explores the creativity of participant and his/her understanding off the structure by implementing simple theories of structure and a little mathematics. In this event, participants have to construct a bridge of given dimensions using Popsicle sticks.
Rules:
1.	Maximum 3 members per team. Members from different institutions can form a team.

2.	Adhesive and 200 Popsicle sticks will be provided on the spot.
3.	It is not mandatory to use all the Popsicle sticks.

4.	Use of materials other than given is not permitted.
5.	The organizers have all the rights to change any rule at any point of the event.
6.	Dimensions: Length (span)-50 cm.

Clearance- 5 cm on each side Width-10 cm
Limiting to an error of 2 cm in width & 4 cm in length.

7.	If the structure fails to satisfy any of the above constraints then it will be rejected.

8.	The bridge that meets the above constraints and dimensions supporting maximum weight at centre will be declared as the winner.

Efficiency Ratio: Load taken/ weight of the bridge
 
Entry Fees: INR 350 per team.
Prize: Winner: Rs 3,000/- Runner Up: Rs 2,000/-
2nd Runner up: Rs 1,000/- Venue: Basement C-Block
 
Student coordinartors :
Mohan Kumar (8409422389)

Ravi Ranjan Chouhan (6205679186)

Faculty coordinators :
Mr. Yogesh Agrawal Mr. Abhinav Aggarwal Ms. Swarnima



Event Name: Best out of waste

About the event: As the name itself explains "Best Out of Waste". This is an
event in which participants are suppose to make anything to their creativity from
the waste products given to them. We will be providing them with the materials
from which they need to make any 3D model. To highlight the importance of
3R's i.e reduce, reuse & recycle for a better future.

· Rules:
· 1. Maximum 2 members in a team.
· 2. Use of any kind of mechanical or electrical things and waste materials other
than provided is strictly prohibited.
3. Participants must reach half an hour prior to the commencement of the event.
. 4. The model created must consist 70% of waste.
· 5. The judge's decision will be final and cannot be challenged.
...
contact
student coordinator
·1.Monika Bagoria: (7296947376)
pragati bhardwaj:(9783647708)
...
Prize: Winner: Rs 3,000/- Runner Up: Rs 2,000/- 2nd Runner up: Rs 1,000/-
Venue: CP19, 20 (CE) C-Block 19thMarch
Time: 2PM – 4PM
Faculty coordinators :- Mr. Pradeep Kumar Jain Mr. Jitesh Kumar Jain Mr. Sumit Saini
...
. Any extension in the allotted time will result in the disqualification of team (A buzzer will be buzzed at the end of 3 minutes)
. Use of phone is prohibited.
. Teams will be judged on the basis of uniqueness and potential of their business idea.
•	Final decision will lie with the Adjudicators.
...
•	For queries contact:
•	Rahul Raj : 6290355232	Prachee Bagoria : 9414009448
•	(Coordinator)	(Coordinator)



EVENT NAME - APPIE (WEB/APP DEVELOPMENT CONTEST)
Date: 20/03/2024
About the event:
Appie Web/App Development Contest invites participants to showcase their skills in designing and developing innovative web applications.The contest fosters interactive learning through hands-on project development, promotes personalized learning paths, and encourages continuous feedback for improvement. It serves as a platform for students to enhance their skills, collaborate, and compete in a dynamic learning environment.
Rules And Regulations:
•	The contest is open to individuals or team up to 3 members.
•	The contest is open to all B.Tech UG students.
•	Teams must register online within the specified registration period.
•	Teams must submit their final web application along with documentation, instructions for deployment.
•	Teams are required to bring their own laptop.
•	Participants are expected to adhere to a code of conduct.
...
For queries contact:
EVENT HEAD:
Vikash Bairwa : 7568259384 Vishnu Sharma : 8875402719


EVENT NAME - Code Zeal

About the Event:
Event of coding without having power on screen. Opportunity to check the smartness of brain!!!! Code Zeal is a fun based coding event in which there will be two rounds in the event.
Rules and Regulations:
1.	Individual participation will be considered only.
2.	The event will be 2-3 hour long.
3.	The participants are required to write proper executable code in C/C++ Language which is given in the first round with errors and participant have to solve it.
4.	If any of the participants is not able to solve the problems within the predecided time limits then the decision of selecting the participants will be taken based on the best code (code with minimum errors wins).
5.	Winners will be announced based on the results of compilation and execution. In case of TIE: TIE breaking problem statement will be given and time will be monitored.
6.	Problems will be assigned by the organizers of an event.
7.	The participants will be provided with desired work stations. The Workstations will not have any net connections and neither any individual phones.
8.	If any team is found copying a code that has already been debugged/Switching on the screen, then he/she will be disqualified on the spot.

Round 1:
1.	MCQ type question based on DSA & basic programming.
2.	Time limit: 20 minutes.
Round 2:
1.	Complex problem statement will be provided. (The problem statement will be based on Data structures and Algorithm)
...
Prize -
1st Position – Rs.3000/- 2nd Position – Rs. 2000/- 3rd Position – Rs. 1000/-
4 Consolation prizes - Rs. 250/- each


For further queries, contact :
Vinit - 6376161995
Yash Gurjar – 6350042298


EVENT NAME - CRYPTO MINING:
About the event:
Crypto Mining—a dynamic board game for Two to four players! Experience
thrilling dares, surprising twists, and boost your knowledge with interesting
facts. It's all about fun, spontaneity, and learning. Get ready for an
...
The event is divided into 3 rounds:
ROUND 1
Round 1 features 40 players organized into pairs of four, resulting in 10
groups. From these groups, the top player from each group with the
maximum amount of cryptocurrency qualifies for Round 2.

ROUND 2
In Round 2, the 10 qualified players are divided into groups: two groups
with four players each and one group with two players. From each group,
three players will advance to Round 3.
ROUND 3
In Round 3, the three remaining players compete together, and the two
players with the highest amount of cryptocurrency emerge as the
winners.
Registration:
Registration fee- Rs 200/- per member.
Prize Worth• 1st position- Rs 3000/• 2nd position- Rs 2100/• 10 consolation prizes- worth: Rs 500/Participation certificate will be given to all participants.

For queries, contact:
EVENT HEAD:
Tarun Agarwal : 8290369857


EVENT NAME - JECRC TECHNOADS
About the event:
JECRC TechnoAds is basically a technical event in which every team
will be assigned a product to design a logo. Teams whose logo will be
selected after scrutiny are allowed to participate in next round. In
second round, the team has to make a tag line for the product and
prepare a jingle for that product. Team has to perform jingle within the
time limit of 2 minutes.

Rules and Regulations:
1. Team should be of 2-3 members.
2. Use of internet connection is prohibited.
3. In first round 1 hour will be given for logo designing and the team
who will cross the time limit will be disqualified.
4. After scrutiny selected teams will go for second round of jingle
performance. Teams will be given 15 minutes for preparing jingles for
their respective products. Jingle may contain single line or a musical
form
5. Only 2 minutes will be given per team for jingle performance.
6. The team with best logo and best jingle performance will be
awarded.

Guidelines:
1. The teams have to use Photoshop software for logo designing.
2. Any extension in the allotted time will result in the
disqualification of team.
3. Use of phone is prohibited.
4. Teams will be judged on the basis of their creativity and
imagination.
5. Final decision will lie with the Judges.
6. Participants must bring their own devices.

Registration:
Registration fee -Rs 500/- per team

Prize Worth1st Prize: Rs. 4000
2nd Prize: Rs. 2500
3rd Prize: Rs. 2000
Participation certificates will be given to all the participants
For queries contact:
Udaiveer Yadav: 9549329464
Vansh Dhar: 9811175394

Shreya Agarwal: 7579067708
Virender Singh: 8118809628
...
This is hardwate assembling and troubleshooting event with comple booting
process based activity. In this event every team must have at least and at
most two participants. Each has given a CPU cabinet including all the parts
and a screw driver. Within the time limit of 5 minutes every team must have
to assemble the CPU &amp; if the CPU boots which make the team qualify for
the prize. The winners have been selected on the bases of the time taken by
them in assembling.

Rules and Regulations:
In this event every team must have at least and at most two participants.
In each round, 5 teams will be given chance to show their expertise.
Each team will be given a CPU cabinet including all the parts and a screw driver.
Within the time limit of 5 minutes every team will have to assemble the CPU &
the Judges will check for the correct assembling with minimum time.
Judges will be deciding the winner on the basis of minimum time taken for
correct installation with boot.
The consolation winners will also be selected on the basis of the time taken by
them in assembling.
...
Prices Worth:
Ist Position= 3000/2nd Position= 2000/3rd Prosition= 1000/Participation certificates will be given to all participants.

For Queries, contact:
EVENT HEAD:
Shreyansh Jain - 6377994353
Dharmesh Singhal - 8949492740



EVENT NAME - VIRTUAL VISION :
• INTRODUCTION: The Virtual Vision is an event that invites
students to create immersive videos using AR/VR technologies.

• THEME: Theme of the video should be based on the college fest.
It can be a creative interpretation of the theme, but it must be
relevant to the event.

• TEAM SIZE: Team can have maximum three members. Team
members are required to bring their own laptops and camera if
necessary.

• TOOLS AND RESOURCES: Participants can use any AR/VR
video making tool.

• VIDEO LENGTH: The video should not exceed five minutes,
including video credits or any other opening and closing
statements.
• ORGANIZING COMMITTEE: By submitting a video,
participants grant the event organizers the right to use the video
for promotional purposes , with due credit given to the creators.
• EVALUATION: The video will be evaluated by a panel of
judges based on the following criteria :
➢ Creativity and originality
➢ Technical skills and execution
➢ Adherence to theme of college fest
•

• CERTIFICATION POLICY:
➢ Top three teams will be given cash prizes alongside the
certificates.
➢ All participating teams will be receiving certificate of
participation.

• PRICES WORTH :RS 7000/• EVENT COORDINATORS:
➢ ANUSHIKA CHANDEL:6006923753
➢ VAIBHAV JAIN:911661113



EVENT NAME - Tech Spectrum
About the tech spectrum event:
Tech spectrum combines pop culture and tech trivia, testing your.
knowledge of logos, digital taglines, and emoji movies.introduces a thrilling.
drum charades challenge, focusing on creativity, coordination, and quit thinkin
the ultimate tech challenge unfolds with 20 technical and coding questions,
separating the real tech experts from the rest. It's a diverse.and engaging quiz
experience that covers a range of topics!

Rules And Regulations:
1. Each team consist of compulsory 2 persons.
2. The first and second rounds will consist of 20 MCQs.
3. Get ready for some exciting drum charades, where you'll drum up the fun and excitement.
4. Each round has 30 min time
5. In first round only first 15 winning team will move to second round, in second round 5 more teams
are eliminated and in last and final round of tech splash, 7 teams are finalized
6. Bring your mobile phones with you so that you can attend quiz

Round 1: "Guess the Brand, Boss, and Beat” In our first round, get ready to tackle a variety of questions In our first round,
You'll identify famous logos, decode digital taglines, and even explore the world of emoji movies.
From tech gurus to blockbuster hits, this round offers a mix of popculture and tech trivia that'll keep you engaged.
Round 2: "Beat the Challenge” In the second round, get ready for an exciting challenge: drum charades! Use your rhythm
and beats to express tricky ideas. It's all about creativity, coordination, and thinking fast. Get ready for a
thrilling
ride!"
”Round 3: "Dive Deep, Shine Bright” in our last round, get ready for the ultimate tech challenge. We'll dive deep into 20
technical and coding questions. From algorithms to programming, this round is where the real tech experts.
stand out."

Registration:
Registration fee - Rs. 200 - per participant
Prize worth~1st position-Rs 2000/~2nd position-Rs 1700/~3rd position-Rs 1300/~4 consolation prizes: Rs 500/-

participation certificate will be given to all participants
For queries,contact:
EVENT COORDINATORS:
Akshansh:- 8306843969
shreyansh:- 9996189134



EVENT NAME - TECHNOCRAZY
About the event:
Technical events are an amalgamation of fun and learning where spectacular ideas are
displayed, and students learn and feel inspired.
The objective of the event is to create awareness among students about various projects . It will
promote creative ideas and provide a platform for students to share their knowledge. It aims
to inspire the students to think innovatively, develop and come out as a pioneer in
implementing. This event will guide engineers, computer experts, researchers to dream bigger
and achieve them A perfect solution would be provided for a relevant problem statement. With
the goal of encouraging innovation, an environment for learning, developing, and
intellectualising various scientific ideas can be created in this event. Ideas in broad domains,
primarily for the benefit of society/environment/institute initiatives, such as Clean Energy,
Water Conservation and Management, Smart Mobility, and Sustainable Development Goals,
could be submitted. This event could provide a platform for developing the best idea.
The extraordinary event aimed to discuss innovative technologies. Ideas and projects that may
find their business solutions in the cross-border economy.
If you have a passion to think out of the box which can evolve as a new technology then you’ve
reached the right place i.e. “ TECHNOCRAZY .

Rules And Regulations:

• Demonstration time is maximum 10 mins.

• Make team of 2 to 3 members.

• Decision of the judges will be final.

• given Open for all branches.

• Spot enteries are allowed.

• Any act against the spirit of the event will lead to disqualification.

Registration:
Registration fee- Rs 200/- per team.
Prize Worth• 1st Position – 1100/2 nd Position -500/-

Coordinators-

1.Mr.Sathish Sahu – 8306715851
2.Mr.Parth Goyanka - 9680812149
...
Prize Money - Rs 2100/For queries contact:
Puneet Sharma - 8764325055
Suraj Sharma - 7740985229
...
Date: 20/03/2024
About the event :
Flick is a technical event in which, an individual/team will be given a theme at
the starting of the event, based on which he/she will make a short video clip
note more than 2 minutes. This competition aims to encourage filmmakers at all
levels, from aspiring students to passionate amateurs, showcasing their
exceptional talents and abilities.

Rules And Regulations :
• The video should be of 2 min and only based on the theme provided after your
report to the venue.
...
• The video submitted must contain your team name on it, as the name of the
video.
• Ensure that all content in the video including footage images, props is your
own.
• Internet contents are not allowed. Entries containing any unauthorized
...
• Entrants may create a piece of fiction, a documentary, a community-service
announcement, or a music clip is sure to adhere to copyright rules.
• Submitted films can be animated or live action-funny or serious.
• Evaluation will be done based on creativity, uniqueness and clarity of the
video as well as the individual’s Presentation and thoughts behind the
video.
• Team size one or maximum two members.

Registration:
Registrationfee- Rs250/- per person.
Prize Worth• 1 st Position – 3000 / • 10 consolation prizes

- 500 / - per team

Participation certificatewill be given to all participants.
...
“YOU CREATE WE REACT” The Solo Development Competition gives the
platform to Developers to showcase their Styling Skills using “HTML and CSS*. An
event of replicating the given image using HTML and Cascading Style Sheets (CSS)
with multiple round. This is creative activities with lot of Fun. "

RULES AND REGULATIONS

 1. Only solo participation is valid.
2.-Fhere-will be two rounds in the event.
 3. An image will be provided on the spot, and participants have to draw
the-same image with their own HTML/CSS skills and try to mate ir
solution with the given image.
4. Participants have to work on the college provided systems or they can
ring their own laptops.
5. Platform will be notified to participants before one day of the event. All
participants have to work on the same platform.

PRELIMINARY ROUND

In the first-round participants will be given a web page, the
difficulty level will be cakewalk. First round will be of 40 mins and
participants will be automatically eliminated if he/she is unable to build
web page on time and top participants will be qualified to round 2

FINAL ROUND

The second round will be of 1 hour, where difficulty will lightly increase and the

Participants who make it first to complete the given task will be declared
as the winner
...
FOR QUERIES CONTACT
Vanisha Agarw AL- 7742892540
Shristika Kala- 9571056477
...
Event : Pro-Lets
Introduction :
Pro-lets is a coding competition organized in the programming domain
under Renaissance 2024 . A Technical event involving concepts of OOPS
and Programming in C++/Java/Python. It is organized by CSE
department.

Rules of the Event:
Round 1:
1. Round 1 will be of 45 mins.
2. It will be a MCQ round consisting of 45 questions in total and organized
on Speed Exam.
3. Contestants will be awarded 1 mark for each correct answer, 0 for each
incorrect answer and 0 for non-attempted questions.

Round 2:
1. Round 2 will be organized for 2 hrs.
2. It will be a coding round consists of 5 questions.
3. It will be organize on hackerrank.
4.Evaluation will be done by hackerrank on basis of code efficiency and
time of
submission.

Total Event timing is : Round 1 = 45mins and Round 2 = 2hrs and Break
between Round 1 and Round 2 of 45min
Total = 3hrs 30mins including 45mins break.

Certificate Policy :
 Top 3 participants will be rewarded and other consolation prices.
 Certificate of Participation will be only given to the participants.

Entry Fees: Rs. 300/-(solo participant)
Prizes :
1st Position : Rs.3000/2nd Position : Rs.2000/3rd Position : Rs.1000/-

Contacts :
 Mudit Paliwal : 8209741586
 Pratham Chouhan : 8107837740
...
Date: 2 0 /03/2024
About the event:
Get ready to test your knowledge and skills at the “Knowledge Knockout” event!! Prepare to be
challenged, compete with your teammates, and showcase your expertise. With exciting rounds
like “Figure it out”, “Quiz” and “Flashback” it's bound to be a thrilling competition. Join us for
an unforgettable experience where only the smartest will emerge victorious!

Rules And Regulations:
Participants must arrive 10 minutes prior than the event ‘s starting time.
...
Use of internet during the event will be prohibited unless required.
If any participant would be found unfair will be disqualified immediately.

Round 1: Figure it out!
 Describing the situation by gesture/drawing must not be obvious.
 Any whispering will be considered unfair and the participants will be disqualified
immediately.
...
 The winner will be chosen based on accuracy and number of identifications
done.

Registration:
Registration fee- Rs 300/- per participant.

Prize Worth• 1st position- Rs 3100/• 2nd position- Rs 2100/• Consolation Prizes of Rs 500/- from 3rd to 8th
Participation certificate will be given to all participants.

For queries, contact:
EVENT HEAD:
Mihir Kumar: 8279029347
...
About the event:
Technical poster making is a Technical event in which, an individual have to
make a Technical sketch/ diagram like machine or motor. This competition
aims to encourage aspiring students to showcase their talent and abilities in
sketching as well as technical knowledge.

Rules And Regulations:
• One hour will be provided to participants to prepare the sketch.
• It should be based on technical drawings only
• Participants should not have any device with them to restrict any type of
cheating

. Pencil and paper will be provided to all the participants so they don’t
...
Prize Worth• 1st Position – 1100/• 2 nd Position -500/Participation certificate will be given to all participants.
...
Date: 21/03/2024
About the event:
Web Bro is a webpage designing contest. Each participant
will be given 1.30hr to design an innovative webpage based
on a theme/product/course.

Rules And Regulations:
 Team should be of 2 members.
 Site must include adequate text according to the
theme.
 Navigation tabs should be easy to identify and
concisely labelled.
...
Guidelines:
 Any extension in the allotted time will result in the
disqualification of team.
 Use of HTML, CSS, JAVASCRIPT and BOOTSTRAP is
allowed.
 Notepad++ will be provided to execute the code.
 Use of phone is prohibited.
 Teams will be judged on the basis of their creativity
and imagination.
 Final decision will lie with the Judges.

Registrations:
Registration fee- Rs. 500/- per team.

Prizes worth1st Prize: Rs. 4000
2nd Prize: Rs. 2500
3rd Prize: Rs. 2000
Participation certificate will be given to all participants.

For queries, contact:
Mridul Khandelwal- 9511530703
Aditya Jain- 8875386809
Kush Agarwal- 9829853761
Anushka Agarwal- 9057236511


EVENT NAME - Web 3.0 Idea-thon & Build-a-thon
Date: 19/03/2024
About the event:
Whether you are a tech enthusiast, a visionary thinker, or someone curious
about the future of the internet, you are welcome to explore with us the vast
possibilities of Web 3.0, and present your groundbreaking ideas to solve
real-world problems.
Rules And Regulations:
• Submission of Web 3.0 projects
• Comprehensive project description in a pdf document.
• A 10 minute presentation (maximum) showcasing the project.
• A video demonstration of the working model of submitted project.
• Students from all 4 years can participate in this event.
• Participants have to carry their own laptop.
• Team size: 1-4 members.
• The project idea must be original. Plagiarism must be avoided.
• Students should respect other participants, mentors and judges, and maintain
professionalism in all interactions.

• Any team which violates the above mentioned rules will be disqualified. In any
case, the judge’s decision is final and must be abided.
Registration:
Registration fee- Rs 150/- per participant.
Prize Worth• 1st position- Rs 3000/• 2nd position- Rs 2000/• 3rd position- Rs 1000/• 2 consolation prizes: Rs 500/Participation certificate will be given to all participants.

For queries, contact:
EVENT COORDINATORS:
Asmita Goyal: 9630324400
Daksh Jain: 8824188051
...
About the Event:
Puzzle Mania is a series of exciting puzzle games where various teams
compete to solve a series of puzzles, including various fun brain games and
exciting problem-solving games which will test your logical reasoning,
cognitive ability, concentration, and also coordination and teamwork of
your team.

Rules of the Event:
Only team participation is allowed and each team should have 4
participants.
● In the first round, quiz will be played by team using their mobiles on a
certain quiz platform.
● Any kind of cheating will directly lead to the disqualification of the team.
● The second and third round will be allowed to be played only if the team
qualifies the first round successfully.
● The games and rules of the second round will be conveyed to all
the selected teams at the time of event itself.
● In the third round, after successfully clearing 1st and 2nd round,
the new rules for that round will be conveyed.
● The event will be held for approximately 1.5 to 2 hours, in day
time in the college campus.

Rounds of the Event:
The event will be held in 3 rounds. The round will go in the
following manner:
Round 1:
● A quiz test of 10 logical questions will be held. The top teams
who get the higher scores will be qualified for the round 2.

Puzzle Mania
Round 2:
● Some fun games which includes bottle flip, eat or retreat, blow
the candles etc.

● In this round, few teams get selected for the final puzzle Mania.
Round 3:
● This is the final round of the event, which is Jigsaw puzzle, in
which all the team members will solve a jigsaw puzzle, the team
has to sort max number of pieces within the time limit .
...
For any query:
Ishu Jain : 7597028762
Mohit Awana : 7073255465
Apeksh Gupta : 7357929787



EVENT NAME - PROGRAMMER'S PLAYGROUND
Programmer's Playground is an event which invites students to test
their technical knowledge and explore new heights of excellence
with programming.
...
Team should have 2-3 members.

Round 1 :
1. participants have to make a fun theme animation,game,page.
2. 1 hour will be given to each team.
3. No premanufactured projects will be accepted.
4. Judgement will be done on creativeness of the content.

Round 2 :
1. Debate based on technical news,gadgets & basic syntax.
2. Judgement will be done based on maximum correct answers.

Certificates :
Top three participants will be awarded with prizes .
All the partiipants will receive participation certificates.
...
For queries, contact :
Mridul Dave: 6375864369
Tushar Chauhan : 7023390301


EVENT NAME - ELECTRO QUIZZERS
Date: 21/03/2024
About the event:
The quiz consists of some basic engineering questions related to technical stuff .If
you think you can excel in this test try it out and check your knowledge for the same.
Students learn by connecting new knowledge with knowledge and concepts that they
Already know ,most effectively in active social classrooms where they negotiate
understanding through interaction and varied approaches.

Rules And Regulations:
1. In a team the maximum no. of members is 3.
2. Quiz will be based on the basic electrical and electronics engineering with some
interesting questions.
3. There will be 3 rounds.
4. Teams not having cut off marks in each round will be eliminated.
5. In case of any tie there will be sudden death question where team giving correct
answer will qualify for next round.
6. 1st round will be visual round where questions will be displayed and students will
have to answer them.

7. 2nd round will be based on general and logical technical questions.
8. 3rd and final round will be buzzer round.
9. Team with maximum points after the end of 3rd round will be declared winner
of the quiz.
10. In case of any conflict the decision of judges would be final.
11. Use of internet will be strictly prohibited. Any team found with this would be
disqualified.
...
Prize Worth:
• 1st Position – 1500/• 2 nd Position -1100/Participation certificate will be given to all participants.
